...
# ==========================================
# 1. Configurazione e Stile (Street Style)
# ==========================================
...
# CSS Aggiornato per correggere l'uploader e cambiare font dei titoli
st.markdown(f"""
<style>
    ...
    /* TITOLI CON FONT STREET (Bungee) E OMBRA NERA */
    h1, h2, h3, h4 {{
        font-family: 'Bungee', cursive !important;
        color: #FFD700 !important; /* Oro acceso */
        text-align: center;
        text-shadow: 3px 3px 0px #000 !important; /* Ombra netta nera */
        margin-bottom: 20px !important;
    }}

    /* TESTO NORMALE BIANCO E LEGGIBILE */
    ...
    /* Etichette degli slider (Giallo acceso) */
